        ...
        <div class="p-5">
            <div class="">
                <Button
                    ...
                    label="Voltar"
                    @click="navigateTo('/stranger-detective')"
                />
            </div>
...
<script setup>
import Marker from '~/components/stranger-detective/custom/Marker.vue'
import { useStrangerDetectiveFichaStore } from '~/store/stranger-detective/ficha'
